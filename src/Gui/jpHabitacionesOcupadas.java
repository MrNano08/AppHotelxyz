 ...
 * @author UNA
 */
public class jpHabitacionesOcupadas extends javax.swing.JPanel {

    GestorHabitaciones gestorHabitaciones;

    public jpHabitacionesOcupadas() {
        initComponents();
        tblHabitacionesOcupadas.setDefaultRenderer(Object.class, new imgTabla());
        tblHabitacionesOcupadas.setRowHeight(65);
        gestorHabitaciones = new GestorHabitaciones();
        gestorHabitaciones.recuperarDeArchivo();
        tblHabitacionesOcupadas.setModel(gestorHabitaciones.obtenerModeloTablaOcupado());
        lblTotal.setText("Total: " + tblHabitacionesOcupadas.getRowCount());
    ...
    private void initComponents() {
        ...
        tblHabitacionesOcupadas = new javax.swing.JTable();
        ...
        tblHabitacionesOcupadas.setBackground(new java.awt.Color(255, 236, 239));
        tblHabitacionesOcupadas.setFont(new java.awt.Font("Roboto", 1, 12)); // NOI18N
        tblHabitacionesOcupadas.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
        ...
        tblHabitacionesOcupadas.setOpaque(false);
        tblHabitacionesOcupadas.setSelectionBackground(new java.awt.Color(66, 28, 86));
        tblHabitacionesOcupadas.setShowGrid(true);
        jScrollPane1.setViewportView(tblHabitacionesOcupadas);
        if (tblHabitacionesOcupadas.getColumnModel().getColumnCount() > 0) {
            tblHabitacionesOcupadas.getColumnModel().getColumn(0).setPreferredWidth(40);
            tblHabitacionesOcupadas.getColumnModel().getColumn(2).setPreferredWidth(140);
            tblHabitacionesOcupadas.getColumnModel().getColumn(3).setPreferredWidth(80);
            tblHabitacionesOcupadas.getColumnModel().getColumn(4).setPreferredWidth(80);
            tblHabitacionesOcupadas.getColumnModel().getColumn(5).setPreferredWidth(40);
            tblHabitacionesOcupadas.getColumnModel().getColumn(6).setPreferredWidth(20);
        }
    ...
    public JTable getTblHabitaciones() {
        return tblHabitacionesOcupadas;
    }

    public void setTblHabitaciones(JTable tblHabitaciones) {
        this.tblHabitacionesOcupadas = tblHabitaciones;
    }
    ...
    protected javax.swing.JTable tblHabitacionesOcupadas;
